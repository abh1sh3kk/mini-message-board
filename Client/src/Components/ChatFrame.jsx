...
function ChatFrame({ isLoading, chats }) {
    // -------------------------------------------------------------------------------------
    ...
    useEffect(scrollToBottom, [chats.length]);
    // -------------------------------------------------------------------------------------

    if (!isLoading) {
        return (
            <div
                className="chat-container p-2 flex flex-col gap-4 overflow-y-auto max-h-[100%]"
                ref={listRef}
            >
                {chats}
            </div>
    ...
    return (
        <div className="chat-container p-2 flex gap-4 overflow-y-auto min-h-[100%] justify-center">
            <div className="w-full flex justify-center items-center text-[#9415b4]">
                <svg
